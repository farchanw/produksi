    ...
    <div class="modal fade" id="modalCheckout" tabindex="-1" aria-labelledby="modalCheckoutLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="body-modal-checkout" class="my-2"></div>
                    <h5 for="">Payment Method</h5>
                    <div class="mb-4">
                        <button type="button" id="payment-cash" class="btn btn-dark">Cash</button>    
                        <button type="button" id="payment-qris" class="btn btn-outline-dark">QRIS</button>    
                        <button type="button" id="payment-transver" class="btn btn-outline-dark">TRANSFER</button>    
                        <button type="button" id="payment-va" class="btn btn-outline-dark">VA</button>    
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="hidden" name="total_price" id="inp-summary-total">
                                        <input type="hidden" id="inp-summary-changes">
                                        <input type="hidden" id="inp-payment-method">
                                    </td>
                                    <td>
                    ...
                    <div class="mb-4 row">
                        <div class="col-md-6">
                            <input type="text" id="inp-customer_name" name="customer_name" class="form-control mb-2" placeholder="Name">
                        </div>
                        <div class="col-md-6">
                            <input type="number" name="customer_phone" id="inp-customer_phone" class="form-control" placeholder="Phone">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" id="btn-save-order" class="btn btn-dark" onclick="handleSaveOrder()">Save</button>
                </div>
            </div>
        </div>
    </div>
...
@push('fescripts')
    ...
    <script src="{{asset('assets/js/material-order.js')}}"></script>
@endpush
