...
<div class="{{(isset($field['class']))?$field['class']:'form-group'}}">
    ...
    <select id="{{$preffix_method}}{{(isset($field['name']))?str_replace("[]","",$field['name']):'id_'.$key}}" name="{{(isset($field['name']))?$field['name']:'name_'.$key}}" class="form-control idev-form support-tomselect">
