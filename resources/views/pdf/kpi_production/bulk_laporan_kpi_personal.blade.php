            ...
            <table class="info-table">
                <tbody>
                    <tr>
                        ...
                        <td class="value">{{ $evaluation['nama'] ?? '' }}</td>
                    </tr>
                    <tr>
                        <td class="label">NIK</td>
                        <td class="separator">:</td>
                        <td class="value">{{ $evaluation['nik'] ?? '' }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="separator">:</td>
                        <td class="value">{{ $evaluation['periode'] ?? '' }}</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="center bold">{{ $evaluation['records']->sum('bobot') }}</td> <!-- TOTAL BOBOT -->
                        <td colspan="3"></td>
                        <td class="center bold">{{ $evaluation['records']->sum('skor_akhir') }}</td> <!-- TOTAL Skor Akhir -->
                    </tr>
                </tfoot>
            </table>
