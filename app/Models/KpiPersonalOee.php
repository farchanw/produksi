...
class KpiPersonalOee extends Model
{
    use HasFactory;

    protected $table = 'kpi_personal_oees';
    protected $primaryKey = 'id';
    protected $fillable = ["kpi_employees_id","periode","availability","performance","quality","oee","target","bobot","nilai"];
